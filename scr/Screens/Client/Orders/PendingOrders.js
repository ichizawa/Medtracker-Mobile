    ...
    const getPendingOrders = () => {
      try {
          ...
          .then(res => {
              ...
              console.log(data.pending_order)
                                    ...
                                    <>
                                        <View style={{flex: 1, flexDirection: 'row'}}>
                                            ...
                                            <View style={{paddingHorizontal: 10,alignItems: 'flex-end', justifyContent: 'space-between'}}>
                                                <Text style={{color: '#f2be16', fontWeight: 'bold', letterSpacing: 3}}>{item.status.toUpperCase()}</Text>
                                            </View>
                                        </View>
                                        <View style={{flex: 1, flexDirection: 'row'}}>
                                        ...
                                        <View style={{flex: 1, flexDirection: 'row', paddingHorizontal: 10, justifyContent: 'flex-end', marginTop: 10}}>
                                            <View style={{flex: 1}}>
                                                <Text style={{fontSize: 14, marginRight: 10, color: '#b2b2b2'}}>Payment Method: {item.payment_method}</Text>
                                            </View>
