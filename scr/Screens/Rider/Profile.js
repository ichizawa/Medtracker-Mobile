          ...
          <View style={{borderBottomColor: '#f2f2f2', borderBottomWidth: 5, padding: 20}}>
            ...
            <View style={{marginBottom: 20}}>
              <View>
                ...
                <TextInput value={firstName} style={{borderWidth: 1.5,borderRadius: 10, borderColor: isFirstFocused ? 'green' : '#b2b2b2', fontSize: 18, paddingVertical: 10, paddingLeft: 10}} editable={false}
            ...
            <View style={{marginBottom: 20}}>
              <View>
                ...
                <TextInput value={lastName} style={{borderWidth: 1.5,borderRadius: 10, borderColor: isLastFocused ? 'green' : '#b2b2b2', fontSize: 18, paddingVertical: 10, paddingLeft: 10}} editable={false}
